...
import type { VendorFGBuildableManufacturer } from "~/game-data/parsers/FGBuildableManufacturer/assert";
...
export type VendorFGBuildableManufacturerVariablePower =
  VendorFGBuildableManufacturer & {
