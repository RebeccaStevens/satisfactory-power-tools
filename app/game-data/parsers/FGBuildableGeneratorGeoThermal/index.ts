...
} from "~/game-data/parsers/abstractFGBuildableGenerator";
...
export function parseFGBuildableGeneratorGeoThermal(
  ...
  return pipe(
    Effect.all([
      ...
      pipe(
        Effect.all({
          variablePowerProductionConstant: parseVendorFloat(
            data.mVariablePowerProductionConstant,
          ),
          variablePowerProductionFactor: parseVendorFloat(
            data.mVariablePowerProductionFactor,
          ),
          variablePowerProductionCycleLength: parseVendorFloat(
          ...
          variablePowerProductionCycleOffset: parseVendorFloat(
