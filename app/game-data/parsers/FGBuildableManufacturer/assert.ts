...
import type { VendorFGBuildableFactory } from "../FGBuildableFactory/assert";

export function assertVendorFGBuildableManufacturer(
  data: unknown,
): asserts data is VendorFGBuildableManufacturer {
  assert(
    typeof data === "object" && data !== null,
    "FGBuildableManufacturer must be an object",
  );
  assert.isEmpty(
    [
