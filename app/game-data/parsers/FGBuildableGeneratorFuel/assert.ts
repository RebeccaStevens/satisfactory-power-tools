...
} from "../abstractFGBuildableGenerator/assert";
...
export type VendorFGBuildableGeneratorFuel =
  VendorAbstractFGBuildableGenerator & {
    m_SFXSockets?: string; // eslint-disable-line ts/naming-convention
    m_CurrentPotential?: string; // eslint-disable-line ts/naming-convention
    mFuelClasses: string;
