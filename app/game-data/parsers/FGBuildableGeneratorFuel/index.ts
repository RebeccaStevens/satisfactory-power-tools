    ...
    Effect.all([
      ...
      pipe(
        Effect.all({
          ...
          fuel: pipe(
            ...
            Effect.forEach((fuel) =>
              Effect.all({
                ...
                supplementalResourceClass: parseVendorString(
          ...
          requiresSupplementalResource: parseVendorBoolean(
            data.mRequiresSupplementalResource,
          ),
          supplementalLoadAmount: parseVendorInt(data.mSupplementalLoadAmount),
          supplementalToPowerRatio: parseVendorFloat(
            data.mSupplementalToPowerRatio,
          ),
        }),
      ),
    ]),
