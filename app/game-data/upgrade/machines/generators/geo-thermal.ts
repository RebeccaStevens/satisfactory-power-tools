  ...
  return pipe(
    ...
    Array.filter(
      (
        ...
        nativeClass: IterableElement<
          typeof generatorGeoThermalMachineNativeClasses
        >;
      ...
      pipe(
        ...
        Array.map(
          (
            ...
            [ClassName, GeneratorGeoThermalMachine & WithNativeClass]
          > =>
            pipe(
              Effect.succeed({
                ...
                power: {
                  min: uom.Power<uom.Mega<uom.Watt>>(
                    vendor.variablePowerProductionFactor * 0.5,
                  ),
                  max: uom.Power<uom.Mega<uom.Watt>>(
                    vendor.variablePowerProductionFactor * 1.5,
                  ),
                },
