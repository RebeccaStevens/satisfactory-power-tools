...
} from "~/game-data/generate/parsers/FGBuildableFactory/assert";

export function assertVendorFGBuildableDockingStation(data: unknown): asserts data is VendorFGBuildableDockingStation {
