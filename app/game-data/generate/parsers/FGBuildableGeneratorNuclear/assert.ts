...
} from "~/game-data/generate/parsers/FGBuildableGeneratorFuel/assert";
...
export function assertVendorFGBuildableGeneratorNuclear(
  ...
  assert.isEmpty(
    ["mCachedLoadPercentage", "mWasteLeftFromCurrentFuel", "mCurrentGeneratorNuclearWarning"].filter(
...
export type VendorFGBuildableGeneratorNuclear = VendorFGBuildableGeneratorFuel & {
