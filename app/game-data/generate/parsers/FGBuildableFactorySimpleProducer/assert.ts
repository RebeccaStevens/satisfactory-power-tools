...
export function assertVendorFGBuildableFactorySimpleProducer(
  ...
  assert(typeof data === "object" && data !== null, "FGBuildableFactorySimpleProducer must be an object");
  assert.isEmpty(
...
export type VendorFGBuildableFactorySimpleProducer = VendorFGBuildableFactory & {
