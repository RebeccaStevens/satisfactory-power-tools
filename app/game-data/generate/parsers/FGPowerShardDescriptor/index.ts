...
import { parseVendorFloat, parseVendorString } from "~/game-data/generate/parsers/primitives";

import { assertVendorFGPowerShardDescriptor } from "./assert";

export function parseFGPowerShardDescriptor(data: unknown): Effect.Effect<FGPowerShardDescriptor, ParseError> {
